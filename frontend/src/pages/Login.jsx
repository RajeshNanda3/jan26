...
const Login = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
    ...
    <form onSubmit={submitHandler} className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <button className="text-black bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" disabled={btnLoading}>{btnLoading ? "Loading..." : "Login"}</button>
